...
extension Reminder {
    static var testData = [
        Reminder(title: "Control Cube and Camera", dueDate: "Ewan", notes: "Cube linear transform with roaming camera" , isComplete: false)
//        Reminder(title: "Hello world", dueDate: "2021/06/17", notes: "Show how a camera in 3D space", isComplete: false),
